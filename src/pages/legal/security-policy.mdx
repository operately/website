...
- We use industry-standard, PCI-compliant third-party billing platforms and payment processors (e.g., Polar.sh and Stripe) to handle payment information
- We do not store or process full credit card numbers on our servers
- All payment transactions are encrypted and transmitted securely directly to our payment processors
