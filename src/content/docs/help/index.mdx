...
If you haven't started using Operately yet:

- **Cloud version**: [Sign up for a free Operately account](https://app.operately.com/sign_up)
- **Self-hosted**: [Set up your own instance](/install) on your infrastructure
