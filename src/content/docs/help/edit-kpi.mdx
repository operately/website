...
4. In the sidebar:
   - **Champion** — search and pick a person, or **Set champion** / **No champion**
   - **Cadence** — click the current value and choose **Weekly** or **Monthly**
   - **Unit** — click the unit text to change it (for example USD, %, users)
   - **Notifications** — **Subscribe** or **Unsubscribe**. Subscribed copy: "You're receiving notifications because you're subscribed to this KPI." Unsubscribed copy: "You're not receiving notifications from this KPI."
5. Under **Actions**, click **Copy URL** to copy the KPI page link. Success toast: **Success** — "KPI URL copied to clipboard".
</Steps>
