...
**Ultimately responsible** for achieving the goal and accountable for providing regular progress updates through [monthly check-ins](/help/check-in-goal).
...
**Monthly check-ins** — Champions must provide monthly updates through Operately's built-in check-in system, including status updates, target progress, and narrative updates about wins, obstacles, and needs.
