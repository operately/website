...
Goals in Operately work like OKRs (Objectives and Key Results) but with more flexibility. You can create simple goals or complex ones with multiple measurable targets. The key is having clear, measurable outcomes that drive your organization forward.

![Screenshot: Work map with company, space, and my work views](./quick-tour/work-map.png)

## What makes Work Maps special

Most project management tools show you a flat list of tasks. Work Maps show you the relationships between work. For example, you can see that "Increase User Acquisition" is a top-level company goal, and under it sits "Optimize ROI of ads" and "Get more users through word of mouth" as marketing projects that drive that goal.
...
- **Progress bars** visualize completion — for goals, this sums up all their targets; for projects, it's based on milestones. Hover a goal's progress to see **Targets** and **Checklist** (or **No targets or checklist**).
...
The **+ Add new item** link at the bottom of any Work Map opens a quick planning dialog. This is where strategic planning becomes efficient. When you add a **Project**, you can choose a **Template** after you set the **Space**. See [Create a project](/help/create-project) and [Project templates](/help/project-templates).

Say you're planning Q4. You can quickly build out your entire quarterly roadmap: "Increase Revenue" as a goal, then within it "Launch Enterprise Plan" and "Optimize Pricing" as projects.
...
## Table and Timeline views (projects)

On **Company Work Map** and **Space Work Map**, open the **projects** tab to switch **Work map view** between **Table** and **Timeline**.

- **Table** — The default list view with status, progress, and next steps.
- **Timeline** — Places dated projects on a timeline for schedule-oriented planning.
