...
<Steps>
1. Open the project, milestone, or task you want to follow.
2. In the task or resource sidebar, find the subscription section labeled **Subscribers**.
3. Click **Subscribe me** to follow updates yourself.
4. To stop following, click **Unsubscribe me**.
</Steps>

![Screenshot: Subscriptions list](./subscriptions.png)
