...
8.  Click **Post discussion** to publish it immediately, **Save as draft** to finish it later, or open the posting options and choose **Schedule for later**.
</Steps>
...
Use **Schedule for later** to prepare a discussion now and publish it at a future date and time.

<Steps>
1. Open the posting options and choose **Schedule for later**.
![Screenshot: Discussion posting options with Schedule for later](./post-options.png)
2. Select a **date** and **time**.
3. Click **Confirm** to save the discussion.
</Steps>

The scheduled time uses your configured timezone and must be in the future. Until it publishes, you can reopen the discussion to edit the content or change the publish date. You can also choose the options **Publish now** or **Save as draft**.

Scheduled discussions are visible to their author but stay hidden from other readers until they publish. See [Draft a discussion](/help/draft-discussion) to learn how drafts and scheduled discussions differ.
