...
After a project closes, its reviewer can open the retrospective from the closing activity, project page or the [Review page](/help/review-due-actions). The reviewer can click **Acknowledge Retrospective** to record that it has been reviewed.
