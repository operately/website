...
* A scheduled discussion is not a draft. It appears in the discussion list for its author and remains hidden from other readers until it publishes.
...
*   **Discard draft:** Available from the **...** menu on the draft page. You can also open **Draft actions** on the **Your Drafts** list and choose **Discard draft**, then confirm. This permanently removes the unpublished draft.

Drafts provide a safe way to prepare your thoughts and posts before sharing them widely.

## Change a scheduled discussion

Open a scheduled discussion before its publication time to continue editing it. From its options, you can choose **Publish now** or **Save as draft** instead.
