...
Use API tokens to authenticate the Operately CLI, scripts, integrations, and direct API requests. Agents should follow [Get started as an agent](/help/cli-agents) instead of these browser steps.
