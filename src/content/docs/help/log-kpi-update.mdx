...
1. Open the KPI.
2. Click **Log update**.
3. In the **Log update —** dialog (the title includes the KPI name), enter **Value** in the KPI's unit.
...
<Aside type="caution">
You must **Enter a value** (a number) and **Choose a period** / **Choose a date**. If the value is saved but the optional note fails, you may see **Note not posted** — "The value was recorded, but the note wasn't saved." Do not log the same number again; [add a comment](/help/comment-on-kpi-update) on that update instead.
</Aside>
