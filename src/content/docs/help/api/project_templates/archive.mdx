---
title: "Project Templates API: Archive"
description: "Archive with the Operately Project Templates API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/project_templates/archive` |
| Handler | `OperatelyWeb.Api.ProjectTemplates.Archive` |
