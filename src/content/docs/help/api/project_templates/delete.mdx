---
title: "Project Templates API: Delete"
description: "Delete with the Operately Project Templates API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/project_templates/delete` |
| Handler | `OperatelyWeb.Api.ProjectTemplates.Delete` |
