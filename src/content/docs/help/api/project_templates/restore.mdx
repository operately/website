---
title: "Project Templates API: Restore"
description: "Restore with the Operately Project Templates API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/project_templates/restore` |
| Handler | `OperatelyWeb.Api.ProjectTemplates.Restore` |
