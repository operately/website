---
title: "acknowledge"
description: "Generated reference for the mutation endpoint project_check_ins/acknowledge."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/project_check_ins/acknowledge` |
| Handler | `OperatelyWeb.Api.ProjectCheckIns.Acknowledge` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/project_check_ins/acknowledge\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"id\":\"value\"}'"} />
