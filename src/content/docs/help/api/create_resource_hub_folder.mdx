---
title: "create_resource_hub_folder"
description: "Generated reference for the mutation endpoint create_resource_hub_folder."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/create_resource_hub_folder` |
| Handler | `OperatelyWeb.Api.Mutations.CreateResourceHubFolder` |
