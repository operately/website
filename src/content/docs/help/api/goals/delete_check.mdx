...
description: "Delete check with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/delete_check` |
| Handler | `OperatelyWeb.Api.GoalChecks.Delete` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/goals/delete_check\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"check_id\":\"value\", \"goal_id\":\"value\"}'"} />
