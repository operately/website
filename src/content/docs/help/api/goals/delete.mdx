...
description: "Delete with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/delete` |
| Handler | `OperatelyWeb.Api.Goals.Delete` |
