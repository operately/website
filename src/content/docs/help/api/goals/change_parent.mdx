...
description: "Change parent with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/change_parent` |
| Handler | `OperatelyWeb.Api.Goals.ChangeParent` |
