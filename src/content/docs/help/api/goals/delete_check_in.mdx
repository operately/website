---
title: "Goals API: Delete check in"
description: "Delete check in with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/delete_check_in` |
| Handler | `OperatelyWeb.Api.Goals.DeleteCheckIn` |
