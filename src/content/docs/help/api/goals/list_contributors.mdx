...
description: "List contributors with the Operately Goals API."
---
...
| Type | `query` |
| Method | `GET` |
| Path | `/api/external/v1/goals/list_contributors` |
| Handler | `OperatelyWeb.Api.Goals.ListContributors` |
...
<CurlExampleBlock client:load command={"curl --request GET \\\n  --url \"https://app.operately.com/api/external/v1/goals/list_contributors?goal_id=value\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\""} />
