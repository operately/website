...
description: "Delete target with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/delete_target` |
| Handler | `OperatelyWeb.Api.Goals.DeleteTarget` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/goals/delete_target\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"goal_id\":\"value\", \"target_id\":\"value\"}'"} />
