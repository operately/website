...
description: "Update reviewer with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/update_reviewer` |
| Handler | `OperatelyWeb.Api.Goals.UpdateReviewer` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/goals/update_reviewer\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"goal_id\":\"value\", \"reviewer_id\":\"value\"}'"} />
