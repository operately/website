...
description: "Update space with the Operately Goals API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/goals/update_space` |
| Handler | `OperatelyWeb.Api.Goals.UpdateSpace` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/goals/update_space\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"goal_id\":\"value\", \"space_id\":\"value\"}'"} />
