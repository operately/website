...
description: "Delete folder with the Operately Resource Hubs API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/resource_hubs/delete_folder` |
