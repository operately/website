---
title: "remove_company_admin"
description: "Generated reference for the mutation endpoint remove_company_admin."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/remove_company_admin` |
| Handler | `OperatelyWeb.Api.Mutations.RemoveCompanyAdmin` |
