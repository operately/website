...
description: "Get binded with the Operately People API."
---
...
| Type | `query` |
| Method | `GET` |
| Path | `/api/external/v1/people/get_binded` |
| Handler | `OperatelyWeb.Api.People.GetBinded` |
...
<CurlExampleBlock client:load command={"curl --request GET \\\n  --url \"https://app.operately.com/api/external/v1/people/get_binded?resourse_id=value&resourse_type=value\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\""} />
