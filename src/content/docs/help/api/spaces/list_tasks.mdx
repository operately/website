...
description: "List tasks with the Operately Spaces API."
---
...
| Type | `query` |
| Method | `GET` |
| Path | `/api/external/v1/spaces/list_tasks` |
| Handler | `OperatelyWeb.Api.Spaces.ListTasks` |
...
<CurlExampleBlock client:load command={"curl --request GET \\\n  --url \"https://app.operately.com/api/external/v1/spaces/list_tasks?space_id=value\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\""} />
