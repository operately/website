...
description: "Archive discussion with the Operately Spaces API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/spaces/archive_discussion` |
| Handler | `OperatelyWeb.Api.Spaces.ArchiveDiscussion` |
