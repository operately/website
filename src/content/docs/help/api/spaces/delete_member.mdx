...
description: "Delete member with the Operately Spaces API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/spaces/delete_member` |
| Handler | `OperatelyWeb.Api.Spaces.DeleteMember` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/spaces/delete_member\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"member_id\":\"value\", \"space_id\":\"value\"}'"} />
