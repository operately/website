...
description: "Update tools with the Operately Spaces API."
---
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/spaces/update_tools\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"space_id\":\"value\", \"tools\":{\"discussions_enabled\":true, \"kpis_enabled\":true, \"resource_hub_enabled\":true, \"tasks_enabled\":true, \"templates_enabled\":true}}'"} />
