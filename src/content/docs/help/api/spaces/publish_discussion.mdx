...
description: "Publish discussion with the Operately Spaces API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/spaces/publish_discussion` |
| Handler | `OperatelyWeb.Api.Spaces.PublishDiscussion` |
