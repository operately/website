...
description: "Update with the Operately Spaces API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/spaces/update` |
| Handler | `OperatelyWeb.Api.Spaces.Update` |
