---
title: "join_space"
description: "Generated reference for the mutation endpoint join_space."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/join_space` |
| Handler | `OperatelyWeb.Api.Mutations.JoinSpace` |
