...
description: "Mark as read with the Operately Notifications API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/notifications/mark_as_read` |
| Handler | `OperatelyWeb.Api.Notifications.MarkAsRead` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/notifications/mark_as_read\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"id\":\"value\"}'"} />
