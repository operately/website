...
description: "Unsubscribe with the Operately Notifications API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/notifications/unsubscribe` |
| Handler | `OperatelyWeb.Api.Notifications.Unsubscribe` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/notifications/unsubscribe\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"subscription_list_id\":\"value\"}'"} />
