---
title: "convert_company_member_to_guest"
description: "Generated reference for the mutation endpoint convert_company_member_to_guest."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/convert_company_member_to_guest` |
| Handler | `OperatelyWeb.Api.Mutations.ConvertCompanyMemberToGuest` |
