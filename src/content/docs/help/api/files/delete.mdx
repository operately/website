---
title: "files/delete"
description: "Generated reference for the mutation endpoint files/delete."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/files/delete` |
