---
title: "mark_notification_as_read"
description: "Generated reference for the mutation endpoint mark_notification_as_read."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/mark_notification_as_read` |
| Handler | `OperatelyWeb.Api.Mutations.MarkNotificationAsRead` |
