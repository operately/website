...
description: "Pause with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/pause` |
| Handler | `OperatelyWeb.Api.Projects.Pause` |
