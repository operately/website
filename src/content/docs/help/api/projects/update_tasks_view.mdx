---
title: "Projects API: Update tasks view"
description: "Update tasks view with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/update_tasks_view` |
| Handler | `OperatelyWeb.Api.Projects.UpdateTasksView` |
...
<tr>
  <td style={{ whiteSpace: "nowrap" }}><code>tasks_view</code></td>
  <td style={{ whiteSpace: "normal" }}><code>project_tasks_view</code> enum (<code>list</code>, <code>board</code>)</td>
  <td style={{ whiteSpace: "nowrap" }}>Yes</td>
  <td style={{ whiteSpace: "nowrap" }}>No</td>
  <td style={{ whiteSpace: "nowrap" }}>-</td>
</tr>
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/projects/update_tasks_view\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"project_id\":\"value\", \"tasks_view\":\"list\"}'"} />
