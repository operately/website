...
description: "Create key resource with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/create_key_resource` |
| Handler | `OperatelyWeb.Api.Projects.CreateKeyResource` |
