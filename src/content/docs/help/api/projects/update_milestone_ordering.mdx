...
description: "Update milestone ordering with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/update_milestone_ordering` |
| Handler | `OperatelyWeb.Api.Projects.Milestones.UpdateOrdering` |
