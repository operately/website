---
title: "Projects API: Delete check in"
description: "Delete check in with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/delete_check_in` |
| Handler | `OperatelyWeb.Api.Projects.DeleteCheckIn` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/projects/delete_check_in\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"check_in_id\":\"value\"}'"} />
