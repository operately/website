...
description: "Update milestone title with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/update_milestone_title` |
| Handler | `OperatelyWeb.Api.Projects.Milestones.UpdateTitle` |
