...
description: "Search parent goal with the Operately Projects API."
---
...
| Type | `query` |
| Method | `GET` |
| Path | `/api/external/v1/projects/search_parent_goal` |
| Handler | `OperatelyWeb.Api.Projects.SearchParentGoal` |
...
<CurlExampleBlock client:load command={"curl --request GET \\\n  --url \"https://app.operately.com/api/external/v1/projects/search_parent_goal?project_id=value&query=value\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\""} />
