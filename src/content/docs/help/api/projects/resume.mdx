...
description: "Resume with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/resume` |
| Handler | `OperatelyWeb.Api.Projects.Resume` |
