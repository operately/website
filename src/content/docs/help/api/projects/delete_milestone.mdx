...
description: "Delete milestone with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/delete_milestone` |
| Handler | `OperatelyWeb.Api.Projects.Milestones.Delete` |
