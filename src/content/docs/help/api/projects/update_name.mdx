...
description: "Update name with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/update_name` |
| Handler | `OperatelyWeb.Api.Projects.UpdateName` |
