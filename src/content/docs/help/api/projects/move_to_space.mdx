...
description: "Move to space with the Operately Projects API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/projects/move_to_space` |
| Handler | `OperatelyWeb.Api.Projects.MoveToSpace` |
