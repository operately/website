---
title: "edit_company"
description: "Generated reference for the mutation endpoint edit_company."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/edit_company` |
| Handler | `OperatelyWeb.Api.Mutations.EditCompany` |
