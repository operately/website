---
title: "pause_project"
description: "Generated reference for the mutation endpoint pause_project."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/pause_project` |
| Handler | `OperatelyWeb.Api.Mutations.PauseProject` |
