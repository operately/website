---
title: "add_company_admins"
description: "Generated reference for the mutation endpoint add_company_admins."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/add_company_admins` |
| Handler | `OperatelyWeb.Api.Mutations.AddCompanyAdmins` |
