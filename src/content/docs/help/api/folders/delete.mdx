...
description: "Generated reference for the mutation endpoint folders/delete."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/folders/delete` |
| Handler | `OperatelyWeb.Api.Folders.Delete` |
