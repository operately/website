---
title: "remove_reaction"
description: "Generated reference for the mutation endpoint remove_reaction."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/remove_reaction` |
| Handler | `OperatelyWeb.Api.Mutations.RemoveReaction` |
...
<div style={{ overflowX: "auto" }}>
  <table style={{ minWidth: "56rem" }}>
    ...
    <tbody>
      <tr>
  <td style={{ whiteSpace: "nowrap" }}><code>reaction_id</code></td>
