---
title: "remove_company_owner"
description: "Generated reference for the mutation endpoint remove_company_owner."
---
...
| Handler | `OperatelyWeb.Api.Mutations.RemoveCompanyOwner` |
