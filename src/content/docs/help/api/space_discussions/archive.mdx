---
title: "space_discussions/archive"
description: "Generated reference for the mutation endpoint space_discussions/archive."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/space_discussions/archive` |
| Handler | `OperatelyWeb.Api.SpaceDiscussions.Archive` |
...
<div style={{ overflowX: "auto" }}>
  <table style={{ minWidth: "56rem" }}>
    ...
    <tbody>
      <tr>
  <td style={{ whiteSpace: "nowrap" }}><code>message_id</code></td>
