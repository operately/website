...
description: "Update with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/update` |
| Handler | `OperatelyWeb.Api.Companies.Update` |
