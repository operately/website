...
description: "Delete member with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/delete_member` |
| Handler | `OperatelyWeb.Api.Companies.DeleteMember` |
