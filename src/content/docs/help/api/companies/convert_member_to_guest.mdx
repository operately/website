...
description: "Convert member to guest with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/convert_member_to_guest` |
| Handler | `OperatelyWeb.Api.Companies.ConvertMemberToGuest` |
