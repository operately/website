...
description: "Invite guest with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/invite_guest` |
| Handler | `OperatelyWeb.Api.Companies.InviteGuest` |
