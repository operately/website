...
description: "Delete owner with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/delete_owner` |
| Handler | `OperatelyWeb.Api.Companies.DeleteOwner` |
