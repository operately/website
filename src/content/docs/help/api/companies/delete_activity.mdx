---
title: "Companies API: Delete activity"
description: "Delete activity with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/delete_activity` |
| Handler | `OperatelyWeb.Api.Companies.DeleteActivity` |
