...
description: "Delete admin with the Operately Companies API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/companies/delete_admin` |
| Handler | `OperatelyWeb.Api.Companies.DeleteAdmin` |
