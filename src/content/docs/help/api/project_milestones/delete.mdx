---
title: "project_milestones/delete"
description: "Generated reference for the mutation endpoint project_milestones/delete."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/project_milestones/delete` |
| Handler | `OperatelyWeb.Api.ProjectMilestones.Delete` |
...
<CurlExampleBlock client:load command={"curl --request POST \\\n  --url \"https://app.operately.com/api/external/v1/project_milestones/delete\" \\\n  --header \"Authorization: Bearer ${OPERATELY_API_TOKEN}\" \\\n  --header \"Content-Type: application/json\" \\\n  --data '{\"milestone_id\":\"value\"}'"} />
