---
title: "Documents API: Delete link"
description: "Delete link with the Operately Documents API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/documents/delete_link` |
| Handler | `OperatelyWeb.Api.Links.Delete` |
