---
title: "Documents API: Delete document"
description: "Delete document with the Operately Documents API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/documents/delete_document` |
| Handler | `OperatelyWeb.Api.Documents.Delete` |
