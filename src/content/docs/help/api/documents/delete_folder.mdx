---
title: "Documents API: Delete folder"
description: "Delete folder with the Operately Documents API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/documents/delete_folder` |
| Handler | `OperatelyWeb.Api.ResourceHubs.DeleteFolder` |
