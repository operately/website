...
description: "Delete with the Operately Reactions API."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/reactions/delete` |
| Handler | `OperatelyWeb.Api.Reactions.Delete` |
