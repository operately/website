...
description: "Generated reference for the mutation endpoint archive_message."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/archive_message` |
| Handler | `OperatelyWeb.Api.Mutations.ArchiveMessage` |
