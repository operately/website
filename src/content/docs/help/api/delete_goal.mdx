---
title: "delete_goal"
description: "Generated reference for the mutation endpoint delete_goal."
---
...
| Type | `mutation` |
| Method | `POST` |
| Path | `/api/external/v1/delete_goal` |
| Handler | `OperatelyWeb.Api.Mutations.DeleteGoal` |
