...
## Acknowledge a retrospective

After a goal closes, its [reviewer](/help/assign-goal-reviewer) can open the retrospective from the closing activity, goal page or the [Review page](/help/review-due-actions). The reviewer can click **Acknowledge Retrospective** to record that it has been reviewed.

Once acknowledged, the retrospective shows who acknowledged it.
