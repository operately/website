---
title: "Add milestone to a project"
...
If the milestone still has open tasks, Operately asks what to do before completing it.

<Steps>
1. Open the milestone and choose to complete it.
2. Choose **Move tasks to No milestone** or **Change tasks to a closed status**.
3. If you change status, pick a **Task status**.
4. Click **Complete milestone**. Click **Keep milestone active** to cancel.
</Steps>

The milestone page also has a **Docs & Files** tab for the project's documents and files.
