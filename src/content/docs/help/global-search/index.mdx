...
![Screenshot: Space overview showing goals, projects, and discussions](./global-search.png)
...
- **Goals** — Find goals by title, champion, or space
- **Projects** — Find projects by name, owner, or team
- **Milestones** — Locate specific milestones within projects
- **Tasks** — Search for tasks by name or assignee
- **People** — Find colleagues by name, role, or title
