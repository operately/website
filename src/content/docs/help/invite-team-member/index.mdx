...
Company owners and administrators have permission to invite team members to their organization.
...
- **If the person already has an Operately account** using the email address you entered, they will be automatically added to your organization. They'll receive a confirmation email.

- **If the person does not have an Operately account**, they'll receive an email with an invitation link. The link is valid for 24 hours. You can also copy and share the link manually if needed.
...
- **Reissue Invitation**: If the original invitation link expired or was lost, click the **...** menu next to the person's name and select **Re-Issue Invitation** to generate a new 24-hour link.
