...
- **Deactivate Account**: If you need to cancel the invitation before the person accepts, click the **...** menu and select **Deactivate Account**. This will invalidate the invitation link and remove the pending invitation.
