...
To connect Claude, ChatGPT, or another MCP client directly to Operately (without the CLI), see [Connect an AI client with MCP](/help/mcp-connections).
...
Agents should follow [Get started as an agent](/help/cli-agents) to bootstrap a token without the web app. Then configure it:
