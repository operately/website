...
Your new organization will be created instantly, and you'll be taken to the company Work Map to **Add your first project**.
...
- A default **General** [space](/help/intro-to-spaces) will be created
