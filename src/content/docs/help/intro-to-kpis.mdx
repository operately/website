...
- Open a KPI's own page for its description, chart, recorded updates, and sidebar settings
- Log, edit, and delete values, add chart annotations, and comment on updates
...
If you do not see **KPIs** on the space home, a space manager can turn the tool on under **Configure tools**. See [Space tools](/help/space-tools). If **KPIs** is not listed there, the tool is not available for your company yet.
