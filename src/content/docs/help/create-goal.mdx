...
After creating the goal, you'll land on the goal page where you can add details incrementally. Your new goal will start with a 'pending' status until you submit your first check-in.
