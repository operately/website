...
3. Fill in the minimal required information and click **Add Goal**
</Steps>
...
3. Select **Goal** from the dialog 
4. Fill in the details and click **Add Goal**
</Steps>
...
4. Select **Goal** from the dialog (the parent goal will be pre-selected) 
5. Fill in the details and click **Add Goal**
</Steps>
...
If specific people need different access than the baselines, you can grant direct access later from the goal page.
...
**Checklist** — Add checks to track key milestones and deliverables. Perfect for goals with important qualitative outcomes or major accomplishments that matter more than metrics.
...
Your new goal will start with a 'pending' status until you submit your first check-in.

For full permission rules, see [How permissions work](/help/permissions-overview), [Goal permissions](/help/set-goal-privacy), and [Manage goal access](/help/manage-goal-access).
