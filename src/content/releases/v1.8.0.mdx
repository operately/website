...
Operately v1.8 is here. This release makes it easier to bring AI into your work, prepare updates ahead of time, and close the loop on completed goals and projects. You can now connect an AI client through MCP, schedule discussions and check-ins for later, and acknowledge project and goal retrospectives.
...
Learn how to [connect an AI client with MCP](/help/mcp-connections), including guides for [ChatGPT](/help/mcp-chatgpt) and [Claude](/help/mcp-claude).
...
## Retrospective acknowledgements: Close the loop on completed work

When a champion closes a goal or project, they write a retrospective: a look back at the whole effort. Reviewers can now review and acknowledge it the same way it's done with check-ins, by clicking **Acknowledge Retrospective**.
