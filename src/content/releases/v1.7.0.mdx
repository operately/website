...
{/* Screenshots needed — capture before publish and wire up BigImage imports:
  - assets/v170/project-docs-and-files.png — Docs & Files tab on a project with Add menu open
  - assets/v170/goal-docs-and-files.png — Docs & Files tab on a goal
  - assets/v170/draft-check-in.png — draft check-in with Save as draft / Submit actions visible
  - assets/v170/task-reminders.png — Reminders section in task slide-in sidebar
  - assets/v170/keyboard-shortcuts.png — Keyboard Shortcuts Cheatsheet modal
  - assets/v170/work-map-timeline.png — Work Map projects tab in Timeline view
*/}
...
## Draft Check-ins: Save progress updates before you publish

Check-ins on goals and projects can now be saved as drafts. If your update isn't ready to share, use **Save as draft** instead of submitting. Drafts are visible only to you until you publish.

Each goal or project can have one draft check-in at a time. Reopen it from the **Check-ins** tab to edit, discard, or submit when you're ready.
...
**Show previous check-in while writing** — Read the latest check-in inline while drafting the next one on goals and projects.
